...
{
    /// <summary>Lunar Cycle - Phase</summary>
    public class LCP : IIndicator
    {
        ...
        private int _buyPhase = 1;
        private int _sellPhase = 5;
        string myName = "Lunar Cycle - Phase";
        string myDescription = "Buy and sell at lunar phase";
        ...
        public LCP(int period)
        {
            Random rnd = new Random();
            _buyPhase = rnd.Next(1, 8);
            _sellPhase = rnd.Next(1, 8);
            Initialize();
        }

        public LCP(int period, int buylevel, int selllevel)
        {
            _buyPhase = buylevel;
        ...
        {
            _name = "LCP." + "0," + _buyPhase.ToString() + "," + _sellPhase.ToString();
            _ready = true;
            _signal = 9;
        }
